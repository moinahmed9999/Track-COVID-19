 ...
 */
public class IndiaDailyRecoveredFragment extends Fragment {

    public IndiaDailyRecoveredFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_india_daily_recovered, container, false);
    ...
    private void setCharts() {
        ...
        for (int i=size-60; i<size;i++) {
            int x = Integer.parseInt(time_series.get(i)[6]);
            if (x!=0) {
        ...
        cartesian.yAxis(0).title("Number of Daily Recovered Cases");
