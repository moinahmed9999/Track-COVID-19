 ...
 */
public class IndiaDeathsStatsFragment extends Fragment {

    public IndiaDeathsStatsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_india_deaths_stats, container, false);
        chart = mView.findViewById(R.id.india_deaths_chart);
        setCharts();
        return mView;
    }
    ...
    private void setCharts() {
        ...
        for (int i=0; i<time_series.size();i++) {
            int x = Integer.parseInt(time_series.get(i)[3]);
            if (x!=0) {
