 ...
 */
public class IndiaConfirmedStatsFragment extends Fragment {

    public IndiaConfirmedStatsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_india_confirmed_stats, container, false);
    ...
    private void setCharts() {
        ...
        for (int i=0; i<time_series.size();i++) {
            int x = Integer.parseInt(time_series.get(i)[1]);
            if (x!=0) {
