 ...
 */
public class CountryRecoveredStatsFragment extends Fragment {

    private View mView;
    private AnyChartView chart;

    public CountryRecoveredStatsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_country_recovered_stats, container, false);
        chart = mView.findViewById(R.id.country_recovered_chart);
        setCharts();
        return mView;
    }
    ...
    private void setCharts() {
        ...
        ArrayList<String[]> list = Util.getCountryRecoveredList();
        if (list!=null) {
