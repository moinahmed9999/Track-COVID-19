 ...
 */
public class WorldConfirmedStatsFragment extends Fragment {

    private View mView;
    private AnyChartView chart;

    public WorldConfirmedStatsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_world_confirmed_stats, container, false);
        chart = mView.findViewById(R.id.world_confirmed_chart);
        setCharts();
        return mView;
    }
    ...
    private void setCharts() {
        ...
        ArrayList<String[]> list = Util.getWorldConfirmedList();
