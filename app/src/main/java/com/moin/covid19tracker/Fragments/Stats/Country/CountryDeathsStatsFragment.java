 ...
 */
public class CountryDeathsStatsFragment extends Fragment {

    private View mView;
    private AnyChartView chart;

    public CountryDeathsStatsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_country_deaths_stats, container, false);
        chart = mView.findViewById(R.id.country_deaths_chart);
        setCharts();
        return mView;
    }
    ...
    private void setCharts() {
        ...
        ArrayList<String[]> list = Util.getCountryDeathsList();
        if (list!=null) {
